...
class ADS1220:
    ...
    PIN_DRDY = 25                   # DATA READY pin from adc
    ...
    def config_ADC(self):
        ...
        cfg0 = ADS1220.CFG0_PGA_BYPASS_OFF | ADS1220.CFG0_GAIN_1 | ADS1220.CFG0_MUX_P2N3;
        ...
        self.VREF = 3.3;                      # Set to +2.048V for internal reference
