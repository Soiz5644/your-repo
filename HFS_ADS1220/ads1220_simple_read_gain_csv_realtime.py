...
def ads1220_write_registers(config0):
    # Ecriture sur les 4 registres, CONFIG0 doit avoir PGA_BYPASS=0 (bit 0)
    tx = [0x43, 0x00, config0 & 0xFE, 0x04, 0x10, 0x00]
    spi.xfer2(tx)
...
def main():
    ...
    gain = ask_gain()
    config0 = GAIN_SETTINGS[gain] & 0xFE  # Forcer PGA_BYPASS=0
